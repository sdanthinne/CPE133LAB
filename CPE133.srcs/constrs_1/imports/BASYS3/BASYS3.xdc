...
#set_property PACKAGE_PIN W15 [get_ports {SEL1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {SEL1}]
#set_property PACKAGE_PIN V15 [get_ports {SEL2}]					
...
#set_property PACKAGE_PIN V2 [get_ports {c[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {c[8]}]
#set_property PACKAGE_PIN T3 [get_ports {c[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {c[9]}]
#set_property PACKAGE_PIN T2 [get_ports {c[10]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {c[10]}]
#set_property PACKAGE_PIN R3 [get_ports {c[11]}]					
...
#	set_property IOSTANDARD LVCMOS33 [get_ports clr]
#set_property PACKAGE_PIN T18 [get_ports jk[0]]						
