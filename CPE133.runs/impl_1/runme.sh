...
HD_PWD='C:/Users/Sebastien Danthinne/Documents/Documents/vivadoProjects/CPE133/CPE133.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stateSlow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stateSlow.tcl -notrace
